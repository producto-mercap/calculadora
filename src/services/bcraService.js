 ...
 * Usa el ID variable 44 según especificación
 * @param {string} fechaDesde - Fecha desde (formato: YYYY-MM-DD)
 * @param {string} fechaHasta - Fecha hasta (formato: YYYY-MM-DD)
...
const obtenerTAMAR = async (fechaDesde, fechaHasta) => {
    try {
        ...
        while (añoActual <= añoFin) {
            ...
            try {
                // Usar ID variable 44 para TAMAR
                ...
                // La API devuelve: { results: [{ idVariable: 44, fecha: "YYYY-MM-DD", valor: number }] }
                const datos = response.data?.results || [];
 ...
 * Usa el ID variable 7 según especificación
 * @param {string} fechaDesde - Fecha desde (formato: YYYY-MM-DD)
 * @param {string} fechaHasta - Fecha hasta (formato: YYYY-MM-DD)
...
const obtenerBADLAR = async (fechaDesde, fechaHasta) => {
    try {
        ...
        while (añoActual <= añoFin) {
            ...
            try {
                // Usar ID variable 7 para BADLAR
                ...
                // La API devuelve: { results: [{ idVariable: 7, fecha: "YYYY-MM-DD", valor: number }] }
                const datos = response.data?.results || [];
